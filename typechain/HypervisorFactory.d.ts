...
interface HypervisorFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class HypervisorFactory extends BaseContract {
  ...
  interface: HypervisorFactoryInterface;
