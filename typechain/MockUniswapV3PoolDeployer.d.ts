...
interface MockUniswapV3PoolDeployerInterface extends ethers.utils.Interface {
  functions: {
...
export class MockUniswapV3PoolDeployer extends BaseContract {
  ...
  interface: MockUniswapV3PoolDeployerInterface;
